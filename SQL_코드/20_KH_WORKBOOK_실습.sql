...
ALTER TABLE COMPONY RENAME AS COMPANY;
*/
...
INSERT INTO COMPANY
VALUES (company_seq.nextval, '헷에제과', '서울시 강남구', '02-1234-5678');
...
CREATE TABLE SNACKS (
    ...
    SNACK_NAME VARCHAR(100) NOT NULL, -- 과자이름 (NULL 불가)
...
INSERT INTO SNACKS
VALUES(snacks_seq.nextval, '조코파이', 2000, 2);
...
-- 회사 ID가 1인 과자 조회 -- COMPANY
SELECT *
FROM SNACKS
WHERE COMPANY_ID = 1;

-- 회사 ID가 1이고 그 회사에 과자들 조회 (JOIN)
