...
개발 연습이기 때문에 단독으로 진행해도 GOOD
******/

-- INSERT UPDATE DELETE 를 위해 연습용 테이블 만들어 줄 것
...
-- 단, 컬럼의 순서를 지켜서 VALUES 값에 값을 기입

-- 모두 INSERT 해줄 것이기 때문에 컬럼명 생략

INSERT INTO EMPLOYEE2 VALUES(800, '동그라미', '870825-2123456','hello@naver.com', '01076996190', 'D1', 'J7','S3',4300000, 0.2, 200,SYSDATE, NULL, 'N');
...
-- 동그라미 신입인데 혼자 부서에 있으라고요 ???
ROLLBACK; -- 저장X 돌아가기

-- INSERT 에서 특정 부분을 선택해서 넣을 때는 컬럼명을 작성해서 넣어줌
-- INSERT INT 테이블명 (컬럼명1, 컬럼명2,...) VALUES (컬럼명1에 해당하는값, 컬럼명2에 해당하는값,..);
